...
public class AddOrder extends AddEntities {
    ...
    public void setDao(OrderDao orderDao, UserDao userDao){
        this.orderDao = orderDao;
        this.userDao = userDao;
    }

    public String add(HttpServletRequest request) throws IndexOutOfBoundsException, SQLException, NullPointerException, EJBException {
